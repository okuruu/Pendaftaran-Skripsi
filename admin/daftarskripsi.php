...
<head>
	...
	<title>Pendaftaran Skripsi - Universitas Widyagama Malang</title>
    <!-- Bootstrap core CSS -->
	...
	?>
     ...
     <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Pendaftaran Skripsi</h2>
        <p class="lead">Untuk dapat mengajukan <strong><i>Pendaftaran Judul Skripsi</i></strong>, maka anda harus menempuh Mata Kuliah <i>Metode Penelitian</i> sebagai syarat untuk dapat mengajukan <i>Pendaftaran Skripsi</i>.</p>
      </div>

	<div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-gray mb-0">Judul Seminar Hasil 	:  <font color=red><i><?php $cekz = mysqli_query($koneksi,"select * from mhs where NIM='$NIM'");$jumlah = mysqli_num_rows($cekz);while($baris = mysqli_fetch_assoc($cekz)){echo $baris['JUSKRIP'];}?></i></font></h6>
		<h6 class="border-bottom border-gray pb-2 mb-0">Jurusan 	:  <font color=red><i><?php $cekz = mysqli_query($koneksi,"select * from mhs where NIM='$NIM'");$jumlah = mysqli_num_rows($cekz);while($baris = mysqli_fetch_assoc($cekz)){echo $baris['JURUSAN'];}?></i></font></h6>
	...
	<p>
      ...
      <div class="row">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div class=text-success>
                ...
                <small class="text-success">Paralel Semester 6</small>
              </div>
			...
			<li class="list-group-item d-flex justify-content-between lh-condensed">
              <div class=text-success>
               <h6 class="my-0">Daftar Skripsi</h6>
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Form Pendaftaran Skripsi</h4>
          <form class="needs-validation" action="updatependaftaranskripsi.php" method=post>
            <div class="row">
            ...
            <div class="mb-3">
              <label for="judul">Judul Skripsi Yang Ingin Diajukan</label>
              <input type="text" class="form-control" id="judul" placeholder="Contoh : Kualitas Pelayanan Jasa dan Pengaplikasiannya di Sektor Publik dalam Industri 4.0"  name=judulskripsi>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" id="state" name=jurusan>
				  ...
				  <option value="Industri">Manajemen</option>
				  <option value="Industri">Akuntansi</option>
				  <option value="Industri">THP</option>
				  <option value="Industri">Agribisnis</option>
				  <option value="Industri">Hukum</option>
                </select>
                <div class="invalid-feedback">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Ajukan Data Pendaftaran Skripsi</button> <br>						
			<hr class="mb-4">
          </form>
        </div>
      </div>
