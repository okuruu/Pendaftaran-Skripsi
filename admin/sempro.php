...
<head>
	...
	<title>Seminar Proposal - Universitas Widyagama Malang</title>
    <!-- Bootstrap core CSS -->
	...
	?>
     ...
     <div class="container">
      <div class="py-5 text-center">
        ...
        <p class="lead">Untuk dapat mengajukan <strong><i>Seminar Proposal</i></strong>, maka anda harus menempuh Mata Kuliah <i>Metode Penelitian</i> sebagai syarat untuk dapat menempuh <i>Seminar Proposal</i>.</p>
      </div>

	<div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-gray mb-0">Judul Seminar Proposal 	:  <font color=red><i><?php $cekz = mysqli_query($koneksi,"select * from mhs where NIM='$NIM'");$jumlah = mysqli_num_rows($cekz);while($baris = mysqli_fetch_assoc($cekz)){echo $baris['JUSEM'];}?></i></font></h6>
		<h6 class="border-bottom border-gray pb-2 mb-0">Dosen Pembimbing	:  <font color=red><i><?php $cekz = mysqli_query($koneksi,"select * from mhs where NIM='$NIM'");$jumlah = mysqli_num_rows($cekz);while($baris = mysqli_fetch_assoc($cekz)){echo $baris['PEMSEM'];}?></i></font></h6>
	...
	<p>
      ...
      <div class="row">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div class=text-success>
                <h6 class="my-0">Seminar Proposal</h6>
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Form Pengajuan Seminar Proposal</h4>
          <form class="needs-validation" action="updatesempro.php" method=post>
            <div class="row">
            ...
            <div class="mb-3">
              <label for="judul">Judul Seminar Proposal Yang Diajukan</label>
              <input type="text" class="form-control" id="judul" placeholder="Contoh : Implementasi Algoritma Fuzzy Pada Perpustakaan Kota Malang"  name=judulsempro>
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Ajukan Data Seminar Proposal</button> <br>						
			<hr class="mb-4">
          </form>
        </div>
      </div>
